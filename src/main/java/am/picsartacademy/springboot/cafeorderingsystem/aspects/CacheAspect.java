...
import am.picsartacademy.springboot.cafeorderingsystem.cache.SoftReferenceCache;
...
public class CacheAspect {
    ...
    @Around("execution(* am.picsartacademy.springboot.cafeorderingsystem.repository.*.*(..))" +
            " || execution(* am.picsartacademy.springboot.cafeorderingsystem.controller.*.*(..))")
